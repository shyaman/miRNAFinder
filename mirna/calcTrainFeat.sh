...
(cd motif && python3 motiffeat.py -p pos/meme.xml -n neg/meme.xml -i ../microPred/data/$2 -o $2_motif_train )

(cd triplet && python3 triplet_elements.py -i ../microPred/data/$1 -o $1_triplet_train)
(cd triplet && python3 triplet_elements.py -i ../microPred/data/$2 -o $2_triplet_train)
